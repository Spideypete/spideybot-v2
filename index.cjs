...
<div class="support-modal" id="supportModal">
  ...
  <div class="support-content">
    ...
    <div class="support-option"><a href="https://mailto:peterburke122000@gmail.com" target="_blank">💜 Support Us</a></div>
  </div>
</div>
    ...
    <html>
      ...
      <body>
        ...
        <div style="text-align: center; padding: 3rem 2rem; background: #1a1a1a; border-top: 2px solid #9146FF;">
          ...
          <a href="https://mailto:peterburke122000@gmail.com" target="_blank" class="btn" style="background: #9146FF; font-size: 1.1rem;">💜 Donate via PayPal</a>
      ...
      <body>
        ...
        <div class="container">
          ...
          <div style="text-align: center; padding: 2rem; background: #1a1a1a; border-top: 2px solid #9146FF; margin-top: 3rem;">
            ...
            <a href="https://mailto:peterburke122000@gmail.com" target="_blank" class="btn" style="background: #9146FF;">💜 Donate via PayPal</a>
          </div>
        </div>
        ${supportWidget}
      </body>
